const cipher = {encode:function (deslocamento, senhaString) {
        ...
        if (typeof deslocamento !== "number") {
          throw TypeError ("O deslocamente precisa ser um número")
         }
        else {
          if (typeof senhaString !== "string"){
           throw TypeError ("A senha deve ser letras!")       
         }
          else {  
    ...
    decode:function (deslocamento2, senhaString2){
        ...
        if (typeof deslocamento2 !== "number") {
          throw TypeError ("O deslocamente precisa ser um número")
         }
        else {
          if (typeof senhaString2 !== "string"){
           throw TypeError ("A senha deve ser letras!")       
         }
          else {  
